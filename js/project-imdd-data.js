window.projectImddContent = {
    ...
    hubNav: [
        ...
        { id: 'companies', label: 'Companies', shortLabel: 'Companies', href: 'project-imdd-companies.html', description: 'Browse partner companies hiring through Project IMDD.', icon: 'briefcase' }
    ],
    ...
    employerNote: 'By investing in their growth, companies can build a loyal workforce that can evolve into skilled professionals over time.',
    applicantIntro: [
    ...
    companies: [
        { name: 'ACS Freight Services Pte Ltd', logo: 'images/members/logos/acs-freight-services-pte-ltd.jpg', url: 'https://acsfrt.com.sg/' },
        { name: 'Air Market Logistics (S) Pte Ltd', logo: 'images/members/logos/air-market-express-s-pte-ltd.jpg', url: 'https://airmarket.com.sg/about-airmarket/' },
        { name: 'Alliance 21 Pte Ltd', logo: 'images/members/logos/alliance-21-pte-ltd.jpg', url: 'https://alex.world/', hasApply: true },
        { name: 'Aspac Aircargo Services Pte Ltd', logo: 'images/members/logos/aspac-aircargo-services-pte-ltd.jpg', url: 'https://aspac-aircargo.com.sg/' },
        { name: 'B&H Worldwide (SG) Pte Ltd', logo: 'images/members/logos/b-h-worldwide-sg-pte-ltd.png', url: 'https://bhworldwide.com/working-with-us/?utm_source=projectimdd&utm_medium=referral&utm_campaign=projectimdd', hasApply: true },
        { name: 'Clasquin Singapore Pte Ltd', logo: 'images/project-imdd/companies/clasquin-singapore-pte-ltd.png', url: 'https://www.clasquin.com/en/' },
        { name: 'Commonwealth Kokubu Logistics Pte Ltd', logo: 'images/project-imdd/companies/commonwealth-kokubu-logistics-pte-ltd.png', url: 'https://www.cklogasia.com/' },
        { name: 'Crane Worldwide Logistics (S) Pte Ltd', logo: 'images/project-imdd/companies/crane-worldwide-logistics-s-pte-ltd.jpg', url: 'https://www.craneww.com/locations/singapore/singapore/', hasApply: true },
        { name: 'Dachser (Singapore) Pte Ltd', logo: 'images/project-imdd/companies/dachser-singapore-pte-ltd.png', url: 'https://www.dachser.com/en/' },
        { name: 'Flycraft SG Pte Ltd', logo: 'images/project-imdd/companies/flycraft-sg-pte-ltd.jpg', url: 'https://www.flycraft.sg/' },
        { name: 'Global Airfreight International Pte Ltd', logo: 'images/members/logos/global-airfreight-international-pte-ltd.png', url: 'https://www.globalair.com.sg/' },
        { name: 'KC INTL LOGISTICS SINGAPORE PTE LTD', logo: 'images/project-imdd/companies/kc-intl-logistics-singapore-pte-ltd.png', hasApply: true, url: 'https://www.kc-intl.com/' },
        { name: 'Leschaco Pte Ltd', logo: 'images/project-imdd/companies/leschaco-pte-ltd.jpg', url: 'https://www.leschaco.com/en/start.html' },
        { name: 'LOGISTEED Singapore Pte Ltd', logo: 'images/members/logos/logisteed-asia-pacific-pte-ltd.png', url: 'https://sg.logisteed.com/' },
        { name: 'Logwin Air+Ocean Singapore Pte Ltd', logo: 'images/members/logos/logwin-air-ocean-singapore-pte-ltd.png', url: 'https://www.logwin-logistics.com/index.php' },
        { name: 'Morrison Express Logistics Pte Ltd', logo: 'images/project-imdd/companies/morrison-express-logistics-pte-ltd.png', url: 'https://www.morrisonexpress.com/' },
        { name: 'Nanhai Business Solutions', logo: 'images/project-imdd/companies/nanhai-business-solutions.jpg', url: 'https://www.yusen-logistics.com/sg_en/about-us/nanhai-business-solutions' },
        { name: 'NGFS (Singapore) Pte Ltd', logo: 'images/project-imdd/companies/ngfs-singapore-pte-ltd.png', url: 'https://www.ngfsworld.com/' },
        { name: 'Ninja Logistics Pte. Ltd.', logo: 'images/project-imdd/companies/ninja-logistics-pte-ltd.png', hasApply: true, url: 'https://www.ninjavan.co/en-sg/support/contact-us' },
        { name: 'SAAA@Singapore', logo: 'images/saaa-logo.png', url: 'http://saaa.org.sg/', hasApply: true },
        { name: 'SATS Ltd', logo: 'images/sats-logo.png', url: 'https://www.sats.com.sg/' },
        { name: 'SFS Global Logistics Pte Ltd', logo: 'images/project-imdd/companies/sfs-global-logistics-pte-ltd.png', url: 'https://www.sfspharma.com/' },
        { name: 'Sky Leader Freight Pte Ltd', logo: 'images/members/logos/sky-leader-freight-pte-ltd.png', url: 'https://www.linkedin.com/company/skyleaderfreight/?originalSubdomain=sg', hasApply: true },
        { name: 'Skylift Consolidator (Pte) Ltd', logo: 'images/members/logos/skylift-consolidator-pte-ltd.png', url: 'https://www.skylift.com.sg/' },
        { name: 'Speedmark Air Transportation Pte Ltd', logo: 'images/members/logos/speedmark-air-transportation-pte-ltd.jpg', url: 'https://www.speedmark.com.sg/' },
        { name: 'Union Air Freight (S) Pte Ltd', logo: 'images/members/logos/union-air-freight-s-pte-ltd.png', url: 'http://www.uafsin.com.sg/', hasApply: true },
        { name: 'VTQ85 Transport Pte Ltd', logo: 'images/project-imdd/companies/vtq85-transport-pte-ltd.jpg' },
        { name: 'Yat Lye Airfreight Pte Ltd', logo: 'images/project-imdd/companies/yat-lye-airfreight-pte-ltd.png', url: 'https://yatlyeairfrt.sg/' },
        { name: 'Yusen Logistics (Singapore) Pte Ltd', logo: 'images/members/logos/yusen-logistics-singapore-pte-ltd.png', url: 'https://www.yusen-logistics.com/' }
    ],
    testimonials: [
