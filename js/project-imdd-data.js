window.projectImddContent = {
    ...
    companies: [
        ...
        { name: 'Clasquin Singapore Pte Ltd', url: 'https://www.clasquin.com/en/' },
        { name: 'Commonwealth Kokubu Logistics Pte Ltd', url: 'https://www.cklogasia.com/' },
        { name: 'Crane Worldwide Logistics (S) Pte Ltd', url: 'https://www.craneww.com/locations/singapore/singapore/', hasApply: true },
        { name: 'Dachser (Singapore) Pte Ltd', url: 'https://www.dachser.com/en/' },
        { name: 'Flycraft SG Pte Ltd', url: 'https://www.flycraft.sg/' },
        ...
        { name: 'KC INTL LOGISTICS SINGAPORE PTE LTD', hasApply: true, url: 'https://www.kc-intl.com/' },
        { name: 'Leschaco Pte Ltd', url: 'https://www.leschaco.com/en/start.html' },
        ...
        { name: 'Morrison Express Logistics Pte Ltd', url: 'https://www.morrisonexpress.com/' },
        { name: 'Nanhai Business Solutions', url: 'https://www.yusen-logistics.com/sg_en/about-us/nanhai-business-solutions' },
        { name: 'NGFS (Singapore) Pte Ltd', url: 'https://www.ngfsworld.com/' },
        { name: 'Ninja Logistics Pte. Ltd.', hasApply: true, url: 'https://www.ninjavan.co/en-sg/support/contact-us' },
        ...
        { name: 'SFS Global Logistics Pte Ltd', url: 'https://www.sfspharma.com/' },
        ...
        { name: 'Yat Lye Airfreight Pte Ltd', url: 'https://yatlyeairfrt.sg/' },
