...
export function SiteNav({ variant = "subpage" }: SiteNavProps) {
  const navDropdowns = getNavDropdowns(variant);
  const trainingHref = getTrainingHref(variant);
        ...
        <div className="nav-inner">
          ...
          <div ref={navLinksRef} className={`nav-links${mobileOpen ? " mobile-open" : ""}`}>
            {navDropdowns.map((dropdown) => (
              <div
                key={dropdown.label}
                className={`nav-dropdown${openDropdown === dropdown.label ? " open" : ""}`}
              >
                <div className="nav-dropdown-head">
                  <Link
                    href={dropdown.triggerHref}
                    className="nav-dropdown-trigger"
                    onClick={(event) => handleHashClick(event, dropdown.triggerHref)}
                  >
                    {dropdown.label}
                  </Link>
                  <button
                    ...
                    aria-label={`Toggle ${dropdown.label} submenu`}
                    onClick={(event) => {
                      event.preventDefault();
            ...
            <Link
              ...
              onClick={(event) => handleHashClick(event, trainingHref)}
            >
              Training
            </Link>
