...
BASE_STYLES = '''        :root { --red-600: #c41e3a; --red-700: #9b1b2f; --red-50: #fef2f2; --red-100: #fee2e2; --slate-50: #f8fafc; --slate-100: #f1f5f9; --slate-200: #e2e8f0; --slate-300: #cbd5e1; --slate-400: #94a3b8; --slate-500: #64748b; --slate-600: #475569; --slate-700: #334155; --slate-800: #1e293b; --slate-900: #0f172a; --white: #ffffff; --radius-sm: 8px; --radius: 12px; --radius-lg: 16px; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero h1 { font-size: 3.5rem; color: white; margin-bottom: 20px; max-width: none; }
        .hero h1 .accent { color: #ff6b7a; }
        .hero p { font-size: 18px; color: rgba(255,255,255,0.75); margin-bottom: 32px; max-width: 720px; line-height: 1.6; }
        ...
        .section-desc { color: var(--slate-600); font-size: 17px; line-height: 1.7; width: 100%; max-width: none; margin: 0 auto; text-align: left; }
        .page-content { width: 100%; text-align: left; }
        ...
        .page-content ul { color: var(--slate-600); font-size: 16px; line-height: 1.8; margin: 0 0 20px 20px; }
        ...
        .contact-hours-card { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; }
        .contact-hours-card h3 { margin-bottom: 4px; }
        .contact-block h4 { font-size: 0.95rem; color: var(--slate-900); margin-bottom: 12px; }
        .contact-list, .hours-list { list-style: none; margin: 0; padding: 0; }
        .contact-list li { display: flex; flex-wrap: wrap; gap: 8px 16px; padding: 10px 0; border-bottom: 1px solid var(--slate-200); font-size: 15px; color: var(--slate-600); }
        .contact-list li:last-child { border-bottom: none; padding-bottom: 0; }
        .contact-list li span:first-child { min-width: 56px; font-weight: 600; color: var(--slate-700); }
        .contact-list a { color: var(--red-600); font-weight: 600; }
        .contact-list a:hover { text-decoration: underline; }
        .hours-list li { display: flex; justify-content: space-between; align-items: baseline; gap: 16px; padding: 12px 0; border-bottom: 1px solid var(--slate-200); font-size: 15px; }
        .hours-list li:last-child { border-bottom: none; padding-bottom: 0; }
        .hours-day { font-weight: 600; color: var(--slate-800); }
        .hours-time { color: var(--slate-600); font-variant-numeric: tabular-nums; white-space: nowrap; }
        ...
        @media (max-width: 768px) { .logo-img { height: 60px; } .hero h1 { font-size: 2.5rem; } .hero { padding: 60px 0; min-height: 400px; } .hero-actions .btn { width: 100%; justify-content: center; } .section { padding: 60px 0; } .section-title { font-size: 1.75rem; } .footer-grid { grid-template-columns: 1fr; gap: 32px; } .footer-bottom { flex-direction: column; gap: 16px; text-align: center; } .hours-list li { flex-direction: column; align-items: flex-start; gap: 4px; } }
...
<li><span>Phone</span><a href="tel:+6565459597">(+65) 6545 9597</a></li>
<li><span>Fax</span><span>(+65) 6543 0147</span></li>
<li><span>Email</span><a href="mailto:scs@saaa.org.sg">scs@saaa.org.sg</a></li>
</ul>
</div>
...
<ul class="hours-list">
<li><span class="hours-day">Monday to Friday</span><span class="hours-time">08:30 – 20:00</span></li>
<li><span class="hours-day">Saturday</span><span class="hours-time">09:00 – 20:00</span></li>
<li><span class="hours-day">Sunday &amp; Public Holidays</span><span class="hours-time">10:00 – 20:00</span></li>
</ul>
</div>
</div>''',
